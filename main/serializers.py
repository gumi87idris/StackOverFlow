...
class ProblemaSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        for image in images.getlist('images'):
            CodeImage.objects.create(image=image, problema=problem)
        return problem
    ...
    def update(self, instance, validated_data):
        ...
        if images.getlist('new_images'):
            ...
            for image in images.getlist('new_images'):
                CodeImage.objects.create(image=image, problema=instance)
        return instance

    def to_representation(self, instance):  # instance - проблемы
...
class ReplySerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        if action == 'list':
            ...
            representation['comments'] = CommentSerializer(instance.commenty.all(), many=True).data
        return representation
